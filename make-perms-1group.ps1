...
Add-MailboxFolderPermission -Identity $mailbox":\Gelöschte Elemente" -User $group -AccessRights PublishingEditor -Confirm:$False
Add-MailboxFolderPermission -Identity $mailbox":\Junk-E-Mail" -User $group -AccessRights PublishingEditor -Confirm:$False

# Hier Senderechte für group vergeben
